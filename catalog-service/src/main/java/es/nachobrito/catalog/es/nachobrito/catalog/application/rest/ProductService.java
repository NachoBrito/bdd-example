...
import es.nachobrito.catalog.es.nachobrito.catalog.domain.model.product.*;
...
public class ProductService {
    ...
    public es.nachobrito.catalog.es.nachobrito.catalog.domain.model.product.Product save(Product product) {
        var entity = new es.nachobrito.catalog.es.nachobrito.catalog.domain.model.product.Product(
